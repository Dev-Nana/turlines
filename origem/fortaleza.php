...
<!--DIVs Menu--><div class="menui"><div class="menui1"><div class="menu2">
                        ...
                        <p class="p2"><a href="formTL.php" class="a1"><img src="./css/cadastro.png" class="icon">  Inciar Sessão &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="espaco">|</span></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="formLogin.php" class="a1"><img src="./css/cadastro.png" class="icon">Entrar&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|</a>&nbsp;&nbsp;</p>
        ...
        <div class="previa">
                ...
                <div class="previa1">
                        <button class="bu1"><a href="inicio.php" class="a2">Passagens</a></button>   
                        ...
                        <button class="bu1"><a href="#con" class="a2">Pacotes</a></button>   
...
<div class="test">
<div class="fortale">
<p class="fortal">Pacotes de Viagens saindo de Fortaleza, Ceará</p>
</div>
...
<!--ORIGEM-->                                   <div class="form2">
                                        ...
                                        <img src="./css/locali.png" class="locali"><input type="text" class="in1" name="pesquisaO" placeholder="Fortaleza CE">
<!--Fecha ORIGEM-->                             </div>

<!--DESTINO-->                                  <div class="form3">
                                        <label class="la2">DESTINO</label>
                                        <img src="./css/locali.png" class="locali"><input type="text" class="in2" name="pesquisaD" placeholder="Não mencionado">
<!--Fecha DESTINO-->                            </div>
