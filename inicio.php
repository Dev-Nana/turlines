...
<!--DIVs Menu--><div class="menui"><div class="menui1"><div class="menu2">
                        ...
                        <p class="p2"><a href="formCadas.php" class="a1">&nbsp;&nbsp;<img src="./css/cadastro.png" class="icon">  Inciar Sessão &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="espaco">|</span></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="formLogin.php" class="a1"><img src="./css/cadastro.png" class="icon">Entrar&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|</a>&nbsp;&nbsp;</p>
        ...
        <div class="previa">
                ...
                <div class="previa1">
                        ...
                        <button class="bu1"><a href="./destino/iracema/hotel.php" class="a2">Transportes</a></button>   
                        <button class="bu1"><a href="#con" class="a2">Passagens</a></button>   
                        <button class="bu1"><a href="./destino/iracema/formGuia.php" class="a2">Guias</a></button>
